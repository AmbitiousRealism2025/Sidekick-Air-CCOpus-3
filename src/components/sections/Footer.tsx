        ...
        >
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 pb-12 border-b border-white/10">
            ...
            <div className="col-span-2 md:col-span-4 lg:col-span-1 mb-8 lg:mb-0">
              <a href="#" className="inline-block font-display font-bold text-2xl text-white mb-4">
                Sidekick<span className="text-steel-blue">Air</span>
              </a>
              <p className="text-white/60 text-sm leading-relaxed mb-6">
                Reimagining recovery with innovative, portable therapy solutions for modern healthcare professionals.
              </p>
              {/* Social links */}
